...
# def jointBLF(Ir, Ib, Ig1, Ig2, H, W, sigma_gr, sigma_dr, sigma_gb, sigma_db, sigma_gg1, sigma_dg1, sigma_gg2,
#                sigma_dg2, borderType=cv2.BORDER_DEFAULT):
...
#
#     Ipr = cv2.copyMakeBorder(Ir, cH, cH, cW, cW, borderType)  # 噪声图r
#     Ipb = cv2.copyMakeBorder(Ib, cH, cH, cW, cW, borderType)  # 噪声图b
#     Ipg1 = cv2.copyMakeBorder(Ig1, cH, cH, cW, cW, borderType)  # 噪声图g1
#     Ipg2 = cv2.copyMakeBorder(Ig2, cH, cH, cW, cW, borderType)  # 噪声图g2
#
#     Igpr = cv2.copyMakeBorder(Igr, cH, cH, cW, cW, borderType)  # 高斯滤波图r
#     Igpb = cv2.copyMakeBorder(Igb, cH, cH, cW, cW, borderType)  # 高斯滤波图b
#     Igpg1 = cv2.copyMakeBorder(Igg1, cH, cH, cW, cW, borderType)  # 高斯滤波图g1
#     Igpg2 = cv2.copyMakeBorder(Igg2, cH, cH, cW, cW, borderType)  # 高斯滤波图g2
#
#     rows, cols = I.shape
#     i, j = 0, 0
...
#             weightb = closenessWeightb * similarityWeightr * similarityWeightb * similarityWeightg1 * similarityWeightg2
#             weightg1 = closenessWeightg1 * similarityWeightr * similarityWeightb * similarityWeightg1 * similarityWeightg2
#             weightg2 = closenessWeightg2 * similarityWeightr * similarityWeightb * similarityWeightg1 * similarityWeightg2
#
...
# def jointBLFrbgxilinx(Ir,Ib,Ig1,H,W,sigma_gr,sigma_dr,sigma_gb,sigma_db,sigma_gg1,sigma_dg1,borderType=cv2.BORDER_DEFAULT):
#     closenessWeightr = getClosenessWeight(sigma_gr,H,W)#高斯距离权重
#     closenessWeightb = getClosenessWeight(sigma_gb, H, W)
#     closenessWeightg1 = getClosenessWeight(sigma_gg1, H, W)
#     cH = int((H-1)/2)
...
#
#
#             weightr = closenessWeightr*similarityWeightr*similarityWeightb*similarityWeightg1
#             weightb = closenessWeightb*similarityWeightb*similarityWeightg1
#             weightg1 = closenessWeightg1*similarityWeightg1
#
#
#             weightr = weightr/np.sum(weightr)
#             weightb = weightb / np.sum(weightb)
