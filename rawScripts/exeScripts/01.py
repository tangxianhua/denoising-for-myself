...
if len(totalinput)!= 8:
    print(r'参数错误! 命令格式为：inputpath outputpath width height offsset[4]')
else:
    path = totalinput[0]
    ...
    savename = os.path.join(savepath,str(timename)+'.raw')
    allnpy = allnpy.astype(np.uint16)
